...
# SMTP configuration for result emails
# TEMPORARY: Force values for Railway testing - DELETE AFTER TESTING
if os.getenv('RAILWAY_ENVIRONMENT') or os.getenv('DATABASE_URL'):  # Detect Railway
    SMTP_CONFIG = {
        'host': 'smtp-relay.brevo.com',
        'port': 587,
        'username': 'PUT_YOUR_BREVO_LOGIN_EMAIL_HERE',  # ← REPLACE THIS
        'password': 'PUT_YOUR_BREVO_SMTP_PASSWORD_HERE',  # ← REPLACE THIS
        'sender': 'plus4academy2025@gmail.com',
        'use_tls': True,
        'use_ssl': False,
        'timeout': 10,
    }
